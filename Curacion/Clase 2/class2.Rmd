...
Sin embargo, una solución que se usa a menudo para identificar el __número óptimo__ de clusters se denomina método ___Elbow__ e implica la observación de un conjunto de números posibles de clusters en relación con cómo minimizan la ___suma de cuadrados__ dentro del cluster. En otras palabras, el método Elbow examina la disparidad dentro del clúster como una función del número de clusters. 
